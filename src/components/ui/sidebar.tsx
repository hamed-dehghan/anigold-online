  ...
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden inset-x-0 top-[81px] bottom-0 "
            style={
              {
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-x-0 top-[80px] bottom-0   z-10 hidden h-[calc(100vh-6rem)] w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
            side === "left"
